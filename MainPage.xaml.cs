...
namespace classi
{
    ...
    "mCzqouGYosjrScgOGFJYrXnusdvXmk33"
        ...
        private void int_tap(object sender, TappedRoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(Interests));
        }

        private void eve_tap(object sender, TappedRoutedEventArgs e)
        {
